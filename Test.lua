-- Ξ|Ω ESP v4 — No loadstring, safe retry with task.wait + recursive call
...
local function startESP()
    local success, err = pcall(function()
        ...
        if not LocalPlayer then
            warn("Ξ|Ω ESP: Waiting for LocalPlayer...")
        ...
        local function renderESP()
            ...
            for _, player in pairs(Players:GetPlayers()) do
                ...
                -- Tracer (simplified vertical line from center)
    ...
    if not success then
        ...
        task.wait(1)
        startESP()  -- recursive retry, safe because loadstring is gone
    end
end
